...
function Signup() {
  ...
  return (
    ...
    <p className='font-mono text-xs text-center'>Join our community</p>
    </div>
    <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSignup)} className="flex flex-col gap-2">
            ...
            />
            <Button loading={isLoading} className="w-full" type="submit">Signup</Button>
        </form>
    </Form>
    <Link className='hover:text-blue-500' to={'/login'}>Already have an account?</Link>
    </div>
</div>
  )
}
